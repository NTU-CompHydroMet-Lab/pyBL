...
props = [BL_Props.MEAN, BL_Props.CVAR, BL_Props.AR1, BL_Props.SKEWNESS, BL_Props.pDRY]
...
params = BLRPRx_params(lambda_=0.01, phi=0.1, kappa=0.1, alpha=2.1, nu=0.3, sigmax_mux=1, iota=0.1)
fitter = BLRPRxFitter()
