...
def Annealing(theta, obj_func, fitting_model, month, timeScaleList, staFile_path, weightFile_path):
    r"""
    ...
    data = df.iloc[month-1].to_numpy()
    weight = Wdf.iloc[month-1].to_numpy()
...
def Basinhopping(theta, obj_func, fitting_model, month, timeScaleList, staFile_path, weightFile_path):
    r"""
...
def Nelder_Mead(theta, obj_func, fitting_model, month, timeScaleList, staFile_path, weightFile_path):
    r"""
